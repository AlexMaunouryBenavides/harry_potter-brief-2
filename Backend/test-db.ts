...
async function readTest() {
    ...
    try {
        const characters = await repository.read();
...
async function createTest() {
    try {
        const characters = await repository.create(
            {
...
async function updateTest (){
    try {
        ...
        const characters = await repository.update(idToEdit, newData);
        console.log(characters);
    } catch (error) {
...
async function deleteTest(){
    try {
        ...
        const characters= await repository.delete(idToDelete);
        console.log(characters);
    } catch (error) {
